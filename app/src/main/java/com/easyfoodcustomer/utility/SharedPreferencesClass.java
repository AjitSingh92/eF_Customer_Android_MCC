...
public class SharedPreferencesClass {
    ...
    public static final String DELIVERY_MOBILE_NUMBER = "deliveryMobileNumber";
    public static final String IS_FOR_TABLE = "isForTable";
    public static final String RESTUARANT_ID = "RESTUARANT_ID";
    public static final String SERVE_STYLE = "SERVE_STYLE";
