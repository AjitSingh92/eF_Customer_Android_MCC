...
import com.lexxdigital.easyfooduserapp.model.address_list_request.AddressDeliveryListRequest;
...
public class AddressDialogFragment extends DialogFragment implements View.OnClickListener, AddressDialogAdapter.OnAddressSelected {
    Context context;
    ...
    public static AddressDialogFragment newInstance(Context context, Boolean isDelivery, OnAddressDialogListener onAddressDialogListener) {
