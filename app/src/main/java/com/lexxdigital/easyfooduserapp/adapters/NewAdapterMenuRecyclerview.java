...
public class NewAdapterMenuRecyclerview extends BaseExpandableListAdapter implements WhatLikeAdapter.PositionInterface{
    ...
    ArrayList<com.lexxdigital.easyfooduserapp.cart_model.final_cart.ProductModifier> showCartProductSize = new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapp.cart_model.final_cart.SizeModifier> showCartSizeModifier = new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapp.cart_model.final_cart.ProductModifier> showCartProductModifier = new ArrayList<>();
