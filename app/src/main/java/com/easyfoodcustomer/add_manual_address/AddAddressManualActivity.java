package com.easyfoodcustomer.add_manual_address;
...
import com.easyfoodcustomer.api.SearchPostalCodeAddressInterface;
...
import com.easyfoodcustomer.utility.ApiClient2;
...
public class AddAddressManualActivity extends AppCompatActivity {
    ...
    public void manageAddress() {
        ...
        try {
            ...
            disposable.add(apiService.manageAddress(PrefManager.getInstance(AddAddressManualActivity.this).getPreference(AUTH_TOKEN, ""),requestModel)
...
//                                finish();
    ...
    public void editmanageAddress() {
        ...
        try {
            ...
            ApiInterface apiService = ApiClient.getClient(this).create(ApiInterface.class);
            CompositeDisposable disposable = new CompositeDisposable();
            disposable.add(apiService.editAddress(PrefManager.getInstance(AddAddressManualActivity.this).getPreference(AUTH_TOKEN, ""),requestModel)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeWith(new DisposableSingleObserver<AddressResponseModel>() {
                        @Override
...
//                                finish();
    ...
    public void callSearchPostAPI(String postcode) {
        ...
        Call<SearchPostCodeResponse> call3 = apiInterface.mSearchPost(PrefManager.getInstance(AddAddressManualActivity.this).getPreference(AUTH_TOKEN, ""),request);
    ...
    private void performSearchPostal(String postCode) {
        ...
        request.setPostCode(postCode);
        Call<PostalCodeAddRes> call = apiInterface.mLogin(PrefManager.getInstance(AddAddressManualActivity.this).getPreference(AUTH_TOKEN, ""),request);
