package com.easyfoodcustomer.order_details_activity;
...
import com.easyfoodcustomer.adapters.order_details.OrderDetailsMenuProductAdapter;
import com.easyfoodcustomer.adapters.order_details.OrderDetailsSpecialOfferProductAdapter;
import com.easyfoodcustomer.adapters.order_details.OrderDetailsUpsellProductAdapter;
import com.easyfoodcustomer.api.CancelInterface;
import com.easyfoodcustomer.api.OrderDetailsInterface;
import com.easyfoodcustomer.cart_db.DatabaseHelper;
import com.easyfoodcustomer.customer_review.CustomerReviewProcess;
...
import com.easyfoodcustomer.model.myorder.OrderDetails;
...
import com.easyfoodcustomer.model.order_details.Data;
import com.easyfoodcustomer.model.order_details.OrderDetailsRequest;
import com.easyfoodcustomer.model.previous_order.datamodel.MealProduct;
import com.easyfoodcustomer.model.previous_order.datamodel.Menu;
import com.easyfoodcustomer.model.previous_order.datamodel.PreviousOrderDetailsModel;
import com.easyfoodcustomer.model.previous_order.datamodel.ProductModifier;
import com.easyfoodcustomer.model.previous_order.datamodel.SizeModifier;
import com.easyfoodcustomer.model.previous_order.datamodel.SizeModifierProduct;
...
public class OrderDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (isInternetOn(OrderDetailActivity.this)) {
                getCardList();
    ...
    public void getCardList() {
        ...
        Call<PreviousOrderDetailsModel> call = apiInterface.mOrderDetailsNew(PrefManager.getInstance(OrderDetailActivity.this).getPreference(AUTH_TOKEN, ""), request);
    ...
    private void initOrder(PreviousOrderDetailsModel.Data data) throws JSONException {
        ...
        orderNo.setText("Order No.: " + data.getOrderNum());
        if (data.getOrderStatus() != null && data.getOrderStatus().trim().length() > 0) {
            ...
            } else if (_orderStatus.equalsIgnoreCase("Prepared")) {

                orderStatus.setText("Prepared");
...
//        sub_product_order_list
        ...
        for (int i = 0; i < data.getOrderDetails().getMenu().size(); i++) {
            ...
            price.setText(getString(R.string.currency) + String.format("%.2f", menu.getSubtotal()));
    ...
    public void cancelOrder() {
        ...
        Call<CancelOrderResponse> call = apiInterface.mCancelOrder(PrefManager.getInstance(OrderDetailActivity.this).getPreference(AUTH_TOKEN, ""), request);
    ...
    public void getOrderAgain(final String orderNumber) {
        ...
        Call<OrderAgainResponse> call3 = apiInterface.getOrderAgain(PrefManager.getInstance(OrderDetailActivity.this).getPreference(AUTH_TOKEN, ""), request);
