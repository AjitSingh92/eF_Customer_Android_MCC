...
import com.easyfoodcustomer.restaurant_details.model.menu_category.MenuProduct;
...
public class ChooseAdapter extends RecyclerView.Adapter<ChooseAdapter.MyViewHolder> {
    ...
    Context mContext;
    ArrayList<com.easyfoodcustomer.restaurant_details.model.show_menu_category.SizeModifier> showCartSizeModifier;
    ArrayList<com.easyfoodcustomer.restaurant_details.model.show_menu_category.SizeModifierProduct> showCartSizeModifierPproduct;
    ...
    public ChooseAdapter(Context mContext, ChooseAdapter.PositionInterface mPositionInterface, ArrayList<String> check, MenuProduct product, int childpos, int pos, TextView price, ArrayList<com.easyfoodcustomer.restaurant_details.model.show_menu_category.SizeModifierProduct> cartSizeModifierPproduct, ArrayList<com.easyfoodcustomer.restaurant_details.model.show_menu_category.SizeModifier> cartSizeModifier, double tPrice) {
    ...
    public void onBindViewHolder(final ChooseAdapter.MyViewHolder holder, final int listPosition) {
        ...
        holder.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.easyfoodcustomer.restaurant_details.model.show_menu_category.SizeModifierProduct smp = showCartSizeModifierPproduct.get(getlistIndex(mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getSizeModifierProducts().get(llpos).getProductId()));

                if (maxCount < mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getMaxAllowedQuantity()) {
                    showCartSizeModifierPproduct.set(getlistIndex(mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getSizeModifierProducts().get(llpos).getProductId()), new com.easyfoodcustomer.restaurant_details.model.show_menu_category.SizeModifierProduct(mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getSizeModifierProducts().get(llpos).getProductId(), mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getSizeModifierProducts().get(llpos).getUnit(), mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getSizeModifierProducts().get(llpos).getModifierProductPrice(), mProduct.getMenuProductSize().get(childposition).getSizeModifiers().get(position).getSizeModifierProducts().get(llpos).getProductName(), Integer.parseInt(holder.proCount.getText().toString()), smp.getTotalPrice() + 0.0));
