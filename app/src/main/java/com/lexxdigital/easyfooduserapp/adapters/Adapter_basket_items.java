...
public class Adapter_basket_items extends RecyclerView.Adapter<Adapter_basket_items.MyViewHolder> {
    ...
    com.lexxdigital.easyfooduserapp.restaurant_details.model.show_menu_category.MenuCategory cart2;
    ...
    public Adapter_basket_items(Context mContext,com.lexxdigital.easyfooduserapp.restaurant_details.model.show_menu_category.MenuCategory cart,int preposition) {
