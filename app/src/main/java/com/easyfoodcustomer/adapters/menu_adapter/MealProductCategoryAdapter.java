...
public class MealProductCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static MealProductCategoryAdapter instance = null;
...
//            }
    ...
    public static MealProductCategoryAdapter getInstance() {
        return instance;
    }

    public void setTotalCount(int parentPosition, boolean isIncrease) {
        if (isIncrease)
    ...
    public int getSelectedCount(int parentPos) {
        return mItem.get(parentPos).getSelectedCount();
    }

    public int getMaxAllowedQunatity(int parentPos) {
        return mItem.get(parentPos).getAllowed_quantity();
    }
