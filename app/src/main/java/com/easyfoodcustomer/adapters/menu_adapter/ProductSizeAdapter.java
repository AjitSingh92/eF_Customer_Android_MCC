                ...
                if (sizeModifierAdapter != null && !isSelect) {
                    ...
                    for (int j = 0; j < sizeModifierAdapter.getSelectedList().size(); j++) {
                        ...
                        SizeModifier sizeModifier = new SizeModifier(sizeModifierAdapter.getSelectedList().get(j).getModifierName(),
                                sizeModifierAdapter.getSelectedList().get(j).getModifierType(), sizeModifierAdapter.getSelectedList().get(j).getModifierId(), sizeModifierAdapter.getSelectedList().get(j).getMinAllowedQuantity(), sizeModifierAdapter.getSelectedList().get(j).getMaxAllowedQuantity(), sizeModifierAdapter.getSelectedList().get(j).getFreeAllowedQuantity(), modifiers);
