...
package com.lexxdigital.easyfooduserapp.cart_model.menu;


public class SizeModifierProduct_ {
     ...
     * @param productId
     */
    public SizeModifierProduct_(String productId, String unit, String modifierProductPrice, String productName) {
        super();
