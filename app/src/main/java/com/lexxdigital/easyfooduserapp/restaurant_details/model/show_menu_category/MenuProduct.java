...
package com.lexxdigital.easyfooduserapp.restaurant_details.model.show_menu_category;
...
public class MenuProduct {
    ...
    public MenuProduct(String menuProductId, String productName, String vegType,String menuProductPrice, String userappProductImage, String ecomProductImage, String productOverallRating, List<MenuProductSize> menuProductSize, List<ProductModifier> productModifiers, Upsells upsells,Double tAmmount, Integer qty) {
        super();
