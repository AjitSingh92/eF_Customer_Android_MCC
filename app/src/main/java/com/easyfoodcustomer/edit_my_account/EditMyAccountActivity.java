package com.easyfoodcustomer.edit_my_account;
...
import com.easyfoodcustomer.api.UpdateMobileInterface;
import com.easyfoodcustomer.api.VerifyOtpInterface;
...
public class EditMyAccountActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public void updateAccountDetail() {
        ...
        Call<EditAccountResponse> call3 = apiInterface.mupdate(PrefManager.getInstance(EditMyAccountActivity.this).getPreference(AUTH_TOKEN, ""),request);
...
//            Toast.makeText(this, "Cancelling, required permissions are not granted", Toast.LENGTH_LONG).show();
    ...
    public void upadteMobileNo() {
        ...
        Call<EditAccountResponse> call3 = apiInterface.updateMobile(PrefManager.getInstance(EditMyAccountActivity.this).getPreference(AUTH_TOKEN, ""),object);
        call3.enqueue(new Callback<EditAccountResponse>() {
            @Override
            public void onResponse(Call<EditAccountResponse> call, Response<EditAccountResponse> response) {
                try {
    ...
    public void verifyOtp(final String otpPin) {
        ...
        Call<EditAccountResponse> call3 = apiInterface.verifyOtp(PrefManager.getInstance(EditMyAccountActivity.this).getPreference(AUTH_TOKEN, ""),object);
        call3.enqueue(new Callback<EditAccountResponse>() {
            @Override
            public void onResponse(Call<EditAccountResponse> call, Response<EditAccountResponse> response) {
                try {
