...
public class AdapterProductModifier extends RecyclerView.Adapter<AdapterProductModifier.MyViewHolder> implements ProductChooseAdapter.PositionInterface{
    ...
    double totalPrice;
    ArrayList<com.lexxdigital.easyfooduserapp.restaurant_details.model.show_menu_category.ProductModifier> showCartProductModifier ;
    ...
    public AdapterProductModifier(Context mContext, MenuProduct product, int childPos,ArrayList<com.lexxdigital.easyfooduserapp.restaurant_details.model.show_menu_category.ProductModifier> cartProductModifier, TextView price,double tPrice) {
