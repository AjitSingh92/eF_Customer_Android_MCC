...
public class AdapterCardList extends RecyclerView.Adapter<AdapterCardList.MyViewHolder> {
   ...
   // private GlobalValues val;
    ...
    public AdapterCardList(Activity mContext, List<Card> dataList, AdapterCardList.PositionSortInterface positionSortInterface) {
        this.mContext = mContext;
        this.dataList = dataList;
        this.positionSortInterface = positionSortInterface;
        //this.val = (GlobalValues) mContext;
    }
    ...
    void makeDefaultCard(final MyViewHolder holder, final int pos, String id) {
        ...
        req.setCardId(id);
        Call<MakeCardDefaultRes> call = apiInterface.mMakeDefault(PrefManager.getInstance(mContext).getPreference(AUTH_TOKEN, ""), req);
    ...
    void deleteCard(final MyViewHolder holder, final int pos, String id) {
        ...
        Call<DeleteCardResponse> call = apiInterface.deleteCard(PrefManager.getInstance(mContext).getPreference(AUTH_TOKEN, ""), request);
