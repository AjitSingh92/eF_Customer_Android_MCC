package com.lexxdigital.easyfooduserapp.add_card;
...
import com.lexxdigital.easyfooduserapp.dialogs.BillingAddressDialogFragment;
...
import com.lexxdigital.easyfooduserapp.restaurant_details.model.show_menu_category.ShowMenuCartDetails;
...
import com.lexxdigital.easyfooduserapp.select_payment_method.model.checkout_request.CartDetails;
import com.lexxdigital.easyfooduserapp.select_payment_method.model.checkout_request.CheckoutRequest;
import com.lexxdigital.easyfooduserapp.select_payment_method.model.checkout_request.Datum;
...
//                        ).show();
                    ...
                    public void onError(Exception error) {
                        ...
                        mProgressDialog.dismiss();
                        Toast.makeText(getApplicationContext(), ((CardException) error).getCode() + ", " + error.getMessage() + " Try again!", Toast.LENGTH_LONG).show();
