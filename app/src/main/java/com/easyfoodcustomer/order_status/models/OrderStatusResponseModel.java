package com.easyfoodcustomer.order_status.models;
...
public class OrderStatusResponseModel implements Serializable {
    ...
    public class Data implements Serializable {
        ...
        public int getIsTableBooking() {
            return isTableBooking;
        }

        public void setIsTableBooking(int isTableBooking) {
        ...
        public String toString() {
            return "Data{" +
                    ...
                    ", isTableBooking='" + landline_number + '\'' +
