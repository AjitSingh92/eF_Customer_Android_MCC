...
package com.easyfoodcustomer.model.landing_page_request;
...
public class RestaurantsDealRequest {
    ...
    public Integer getIsForTableBooking() {
        return isForTableBooking;
    }

    public void setIsForTableBooking(Integer isForTableBooking) {
        this.isForTableBooking = isForTableBooking;
    }

    @SerializedName("isForTableBooking")
    @Expose
