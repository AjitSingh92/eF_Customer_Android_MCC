package com.easyfoodcustomer.change_password;
...
import com.easyfoodcustomer.api.ChangePasswordInterface;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    void callAPI(String curPass, String newPass, String confPassword) {
        ...
        Call<ChangePasswordResponse> call = changePasswordInterface.changePassword(PrefManager.getInstance(ChangePasswordActivity.this).getPreference(AUTH_TOKEN, ""),request);
