package com.easyfoodcustomer.select_address;
...
import com.easyfoodcustomer.adapters.SelectAddressAdapter;
...
public class SelectAddressActivity extends AppCompatActivity implements SelectAddressAdapter.PositionInterface {
    ...
    public void getAddressList() {
        ...
        Call<AddressListResponse> call3 = apiInterface.mLogin(PrefManager.getInstance(SelectAddressActivity.this).getPreference(AUTH_TOKEN, ""),request);
