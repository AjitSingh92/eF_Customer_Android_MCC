package com.easyfoodcustomer.customer_review;
...
import com.easyfoodcustomer.api.RestaurentReviewInterface;
...
public class CustomerReviewProcess extends AppCompatActivity {
    ...
    void ratingSubmit(String overAll, String ratFood, String ratDelv, String ratOrdAgn, String strRecommend) {
        ...
        final RestoReviewRequest request = new RestoReviewRequest(strRestoId, strCustomerId, strOrderId, overAll, ratFood, ratDelv, ratOrdAgn, strRecommend, etComments.getText().toString().trim());
        Call<RestoReviewResponse> call = apiInterface.mRestoRiview(PrefManager.getInstance(CustomerReviewProcess.this).getPreference(AUTH_TOKEN, ""), request);
