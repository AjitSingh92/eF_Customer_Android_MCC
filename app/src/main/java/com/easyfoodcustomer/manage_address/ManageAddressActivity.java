package com.easyfoodcustomer.manage_address;
...
import com.easyfoodcustomer.adapters.AddressSaveAdapter;
...
import com.easyfoodcustomer.api.DelAddressListInterface;
...
public class ManageAddressActivity extends AppCompatActivity implements AddressSaveAdapter.PositionInterface, AddressSaveAdapter.DeletePositionInterface {
    ...
    public void getAddressList() {
        ...
        Call<AddressListResponse> call3 = apiInterface.mLogin(PrefManager.getInstance(ManageAddressActivity.this).getPreference(AUTH_TOKEN, ""),request);
    ...
    public void delAddressList(String id, final int pos) {
        ...
        Call<DelAddressListResponse> call3 = apiInterface.mDeleteList(PrefManager.getInstance(ManageAddressActivity.this).getPreference(AUTH_TOKEN, ""),request);
