...
public class SingleOrderCountAdapter extends RecyclerView.Adapter<SingleOrderCountAdapter.MyViewHolder> {
    ...
    public SingleOrderCountAdapter(Context context, View.OnClickListener onClickListener,
    ...
    @NonNull
    @Override
    public SingleOrderCountAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_meal_cart, viewGroup, false);
        return new SingleOrderCountAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SingleOrderCountAdapter.MyViewHolder holder, int position) {
