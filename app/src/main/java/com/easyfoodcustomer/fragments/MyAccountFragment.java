...
import com.easyfoodcustomer.api.MyAccountInterface;
import com.easyfoodcustomer.change_password.ChangePasswordActivity;
import com.easyfoodcustomer.edit_my_account.EditMyAccountActivity;
import com.easyfoodcustomer.manage_address.ManageAddressActivity;
...
public class MyAccountFragment extends Fragment {
    ...
    public void getUserdDetail() {
        ...
        Call<MyAccountResponse> call3 = apiInterface.mGetProfile(PrefManager.getInstance(getActivity()).getPreference(AUTH_TOKEN, ""),request);
