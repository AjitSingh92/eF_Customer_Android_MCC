...
public class ExpandableAdapterRecycleview extends BaseExpandableListAdapter implements WhatLikeAdapter.PositionInterface{
    ...
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuProductSize> showCartProductSize = new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.SizeModifier> showCartSizeModifier= new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.ProductModifier>  showCartProductModifier = new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuProduct> showCartMenuProduct = new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuCategory> showMenuCategory = new ArrayList<>();
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.ShowMenuCartDetails> ShowMenuCartDetails;
    ArrayList<com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.SpecialOffer> showSpecialOffer = new ArrayList<>();
                ...
                lyItemClick.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mProduct.getMenuProductSize().size() <= 0 && mProduct.getProductModifiers().size() <= 0) {
                            ...
                            showCartMenuProduct.add(new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuProduct(mProduct.getMenuProductId(), mProduct.getProductName(), mProduct.getVegType(), mProduct.getMenuProductPrice(), mProduct.getUserappProductImage(), mProduct.getEcomProductImage(), mProduct.getProductOverallRating(), showCartProductSize, showCartProductModifier, new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.Upsells(), Double.parseDouble(mProduct.getMenuProductPrice()), 1));

                            FinalMenuCartDetails mCat = (FinalMenuCartDetails) finalMenuCartDetails.get(0);

                            showMenuCategory.add(new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuCategory(mCat.getMenuCategory().get(childPosition).getMenuCategoryId(), mCat.getMenuCategory().get(childPosition).getMenuCategoryName(), showCartMenuProduct));

                            ShowMenuCartDetails.add(new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.ShowMenuCartDetails(showSpecialOffer, showMenuCategory));
                ...
                itemRemove.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (Integer.parseInt(itemTotalCount.getText().toString()) > 0) {
                            ...
                            footerCount.setText(String.valueOf(Integer.parseInt(footerCount.getText().toString()) - 1));
                            footerDetails.setText(String.format("%.2f", Double.parseDouble(footerDetails.getText().toString()) - Double.parseDouble(mProduct.getMenuProductPrice())));
                            com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuProduct smp = showCartMenuProduct.get(getlistIndextwo(mProduct.getMenuProductId()));
                            showCartMenuProduct.set(getlistIndextwo(mProduct.getMenuProductId()), new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuProduct(mProduct.getMenuProductId(), mProduct.getProductName(), mProduct.getVegType(), mProduct.getMenuProductPrice(), mProduct.getUserappProductImage(), mProduct.getEcomProductImage(), mProduct.getProductOverallRating(), showCartProductSize, showCartProductModifier, new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.Upsells(), smp.getTotalAmmount() - Double.parseDouble(mProduct.getMenuProductPrice()), smp.getQuantity() - 1));
        ...
        mDialogView.findViewById(R.id.add_items).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               int pPos = 0;
                ...
                showCartMenuProduct.add(new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuProduct(product.getMenuProductId(),product.getProductName(), product.getVegType(),product.getMenuProductPrice(),product.getUserappProductImage(),product.getEcomProductImage(),product.getProductOverallRating(),showCartProductSize,showCartProductModifier,new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.Upsells(),Double.parseDouble(popupTotalPrice.getText().toString()),1));
                Log.e("MODI >> LEN 12 >>",""+showCartProductModifier.size());
                showMenuCategory.add(new com.lexxdigital.easyfooduserapps.restaurant_details.model.show_menu_category.MenuCategory(mCat.getMenuCategory().get(pPos).getMenuCategoryId(),mCat.getMenuCategory().get(pPos).getMenuCategoryName(),showCartMenuProduct));
